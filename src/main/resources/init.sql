...
values (1, '개발자 커리어, IT 업무, 커리어, 매니징, 백엔드개발, 이력서, 모의면접 등 멘토링', '1h30m', 10000, now(), now(), 1, 1, 150),
       ...
       (20, '테스트제목14', '1h30m', 10000, now(), now(), 1, 20, 6),
       (21, '테스트제목15', '1h30m', 10000, now(), now(), 1, 21, 5),
       (22, '테스트제목16', '1h30m', 10000, now(), now(), 1, 22, 5);
commit;
...
values (1, '2023-12-01 11:00:00', '2023-12-01 12:30:00', now(), now(), 'COMPLETE', 2, 1, 1),
       ...
       (19, '2024-01-15 13:00:00', '2024-01-15 14:30:00', now(), now(), 'COMPLETE', 2, 1, 19),
       (20, '2024-01-16 13:00:00', '2024-01-16 14:30:00', now(), now(), 'COMPLETE', 2, 1, 20),
       (21, '2024-02-07 13:00:00', '2024-02-07 14:30:00', now(), now(), 'COMPLETE', 2, 1, 21),
...
values (1, '2023-12-01 15:00:00', now(), 10000, 'WAITING', '2024-01-05 15:00:00', 1, 1),
       ...
       (19, now(), now(), 10000, 'WAITING', '2024-01-10 18:00:00', 1, 19),
       (20, now(), now(), 10000, 'WAITING', '2024-01-10 18:00:00', 1, 20),
       (21, now(), now(), 10000, 'WAITING', '2024-01-10 18:00:00', 1, 21);
commit;